...
import CVT from "../../assets/Christopher-Resume.pdf";
  ...
  return (
    <div className="home_data">
      ...
      <p className="home_description">
        Welcome to my portfolio! Dive in to explore my creations and discover
        the unique vision I bring to every project. Let's collaborate and
        achieve greatness together!
      </p>
      <a download="" href={CVT} className="button button--flex">
        {" "}
        Download CV
        <svg
          class="button__icon"
