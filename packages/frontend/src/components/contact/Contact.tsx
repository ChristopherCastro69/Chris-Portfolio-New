...
const Contact: React.FC = () => {
  ...
  const sendEmail = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      ...
      setStatus({
        type: 'error',
        message: 'Contact form is not configured. Please try again later or reach out directly via email.'
      });
      return;
    }
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">09928944217</span>
              <a
                href="https://api.whatsapp.com/send?phone=09928944217&text=Hello, more information!"
                className="contact_button"
                target="_blank"
                rel="noreferrer"
              >
